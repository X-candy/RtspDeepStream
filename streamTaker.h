...
#ifndef RSTPPLAYER_STREAMTAKER_H
#define RSTPPLAYER_STREAMTAKER_H
...
class StreamTaker {
public :
    StreamTaker(simplelogger::Logger *logger);
...
#endif //RSTPPLAYER_STREAMTAKER_H
